...
router.put("/test",async (req, res) => {
  await Login.findByIdAndUpdate(req.body.data._id, req.body.data)
     await Reqly.updateMany({"name":req.body.name}, {"name":req.body.data.name})
     await Reqly.updateMany({"bname":req.body.name}, {"bname":req.body.data.name})
     await Comment.updateMany({"name":req.body.name}, {"name":req.body.data.name})
    res.send()
})
//玩一下ckooie
...
router.put("/tou",async (req, res) => {
    ...
    await Reqly.updateMany({"icon":req.body.aicon}, {"icon":req.body.bicon})
