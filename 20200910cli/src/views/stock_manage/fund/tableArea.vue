<template>
  <div class="listTemplateTable">
    <!-- default-expand-all -->
    <countTo :startVal='startVal' :endVal='endVal' :duration='duration' @click.native="d1"></countTo>
  <el-table
          ...
          <template slot-scope="scope">
            <el-dropdown trigger="click" placement="bottom" class="displayHide">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-if="true" @click.native="updateEvent(scope.row)">锁定</el-dropdown-item>
...
export default {
  ...
  methods: {
    d1(){
      this.userState.dialogType ='2'

      setTimeout(()=>{console.log(  this.userState.dialogType )},1000)
      this.userState.dialogType ='1'
